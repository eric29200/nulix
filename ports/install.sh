...
BASE_PORTS=("pkgconf" "libncurses" "termcap" "zlib" "bzip2" "openssl" "util-linux"	\
	"libpng" "libjpeg" "libgif" "expat" "freetype2" "fontconfig" "liberation"	\
	"tinyx" "imlib2" "argp-standalone" "musl-fts" "musl-obstack" "libpipeline")
