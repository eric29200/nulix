...
#define KERNEL_CS			SEGMENT_SEL(GDT_ENTRY_KERNEL_CS, DPL_KERNEL)
#define KERNEL_DS			SEGMENT_SEL(GDT_ENTRY_KERNEL_DS, DPL_KERNEL)
#define USER_CS				SEGMENT_SEL(GDT_ENTRY_USER_CS, DPL_USER)
#define USER_DS				SEGMENT_SEL(GDT_ENTRY_USER_DS, DPL_USER)
