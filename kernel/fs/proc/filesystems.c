 ...
 * Read file systems.
 */
static int proc_filesystems_read(struct file *filp, char *buf, int count)
{
	char *tmp_buf;
	size_t len;
 ...
 */
struct file_operations proc_filesystems_fops = {
 ...
 */
struct inode_operations proc_filesystems_iops = {
